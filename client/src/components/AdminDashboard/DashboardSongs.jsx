         ...
         <div className="w-full flex items-center justify-center gap-20">
            ...
            <div className="relative ">
               <div className="group cursor-pointer relative inline-block  text-center">
                  ...
                  <div className="opacity-0 w-24 bg-white text-orange-500 text-center text-xs rounded-lg py-2 absolute z-10 group-hover:opacity-100 bottom-8 -right-10 ml-14 px-3 pointer-events-none duration-200 transition-all ease-in-out">
                     Clear Filters
                  </div>
               </div>
            </div>
